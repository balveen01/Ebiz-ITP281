...
public partial class Admin : System.Web.UI.Page
{
    ...
    protected void gvProduct_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        Response.Redirect("AlacarteAdmin.aspx");
    ...
    protected void gvProduct_RowEditing(object sender, GridViewEditEventArgs e)
    {
        ...
        Response.Redirect("UpdateAlacarte(Admin).aspx?id=" + id);
        
        
        //var id = gvProduct.DataKeys[e.NewEditIndex].Value;
        // Response.Redirect("UpdateAlacarte.aspx?id=" + id);
        gvProduct.EditIndex = e.NewEditIndex;
        bind();
    }

    protected void gvProduct_RowCancellingEdit(object sender, GridViewCancelEditEventArgs e)
    {
    ...
    protected void Insert_Product_Click(object sender, EventArgs e)
    {
