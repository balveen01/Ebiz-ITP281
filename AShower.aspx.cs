...
public partial class AShower : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        prodList = aProd.searchProduct101(name);
        if (prodList.Count == 0)
        {
            ...
            if (string.IsNullOrEmpty(tb_Search.Text))
            {
                this.DataList1.Visible = true;
                lbl_Search.Text = "";
                List<AProduct> prodlistsearch = new List<AProduct>();
                prodlistsearch = aProd.getAllProduct101();
                DataList1.DataSourceID = null;
    ...
    protected void btn_both_Click(object sender, EventArgs e)
    {
        ...
        List<AProduct> filterlist = new List<AProduct>();
        filterlist = aProd.getProduct101ByFilter(category, price);
        DataList1.DataSourceID = null;
